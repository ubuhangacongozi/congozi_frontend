...
const UserStudent = lazy(() => import("./Components/Users/Students/UserStudent"));
...
const StudentMarket = lazy(() => import("./Page/Dashboard/Students/StudentMarket"));
const ManualTracking = lazy(() => import("./Page/Dashboard/Students/ManualTracking"));
const StudentExams = lazy(() => import("./Page/Dashboard/Students/StudentExams"));
const StudentProfile = lazy(() => import("./Page/Dashboard/Students/StudentProfile"));
const StudentUnpaid = lazy(() => import("./Page/Dashboard/Students/StudentUnpaid"));
const StudentWaiting = lazy(() => import("./Page/Dashboard/Students/StudentWaiting"));
const LiveExam = lazy(() => import("./Page/Dashboard/Students/LiveExam"));
const LiveLearn = lazy(() => import("./Page/Dashboard/Students/LiveLearn"));
const StudentResults = lazy(() => import("./Page/Dashboard/Students/StudentResults"));
const SchoolDemo = lazy(() => import("./Page/Dashboard/Students/SchoolDemo"));

// Admin components
const AdminDashboard = lazy(() => import("./Page/Dashboard/Admins/AdminDashboard"));
const AdminExams = lazy(() => import("./Page/Dashboard/Admins/AdminExams"));
const AdminAccounts = lazy(() => import("./Page/Dashboard/Admins/AdminAccounts"));
...
const AdminsPayments = lazy(() => import("./Page/Dashboard/Admins/AdminsPayments"));

// School components
const SchoolsDashboard = lazy(() => import("./Page/Dashboard/schools/SchoolsDashboard"));
const AccountMarket = lazy(() => import("./Page/Dashboard/schools/AccountMarket"));
const SchoolDoExams = lazy(() => import("./Page/Dashboard/schools/SchoolDoExams"));
const SchoolMyExams = lazy(() => import("./Page/Dashboard/schools/SchoolMyExams"));
const SchoolMyAccount = lazy(() => import("./Page/Dashboard/schools/SchoolMyAccount"));
const SchoolUnpaid = lazy(() => import("./Page/Dashboard/schools/SchoolUnpaid"));
const SchoolWaiting = lazy(() => import("./Page/Dashboard/schools/SchoolWaiting"));
const SchoolAccessableExams = lazy(() => import("./Page/Dashboard/schools/SchoolAccessableExams"));
const SchoolAccessedExam = lazy(() => import("./Page/Dashboard/schools/SchoolAccessedExam"));
const SchoolLiveExam = lazy(() => import("./Page/Dashboard/schools/SchoolLiveExam"));
const SchoolLiveLearn = lazy(() => import("./Page/Dashboard/schools/SchoolLiveLearn"));
const SchoolResults = lazy(() => import("./Page/Dashboard/schools/SchoolResults"));

const App = () => {
  const { userRole, loading: userLoading } = useUserContext();
  const [routeLoading, setRouteLoading] = useState(false);
  const [initialLoad, setInitialLoad] = useState(true);
  const location = useLocation(); // Properly use the hook
